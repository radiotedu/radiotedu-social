...
export const ROOM_AMBIENCE: Readonly<Record<ImageRoomId, RoomAmbiencePlan>> = Object.freeze({
  ...
  'grass-amphitheatre': Object.freeze({
    label: 'Grass breeze · amphitheatre lights',
    glows: Object.freeze([
      glow(26, 74, 2.0, 3.0, 0xfff0b0, 0.10, 3_000),
      glow(43, 77, 2.0, 3.0, 0xfff0b0, 0.10, 3_300, 420),
      glow(66, 72, 2.0, 3.0, 0xfff0b0, 0.10, 2_800, 760),
      glow(82, 63, 2.0, 3.0, 0xfff0b0, 0.09, 3_500, 180),
    ]),
    drifts: Object.freeze([
      drift('leaf', 6, 5, 14, 88, 68, 0xb9d765, 0.56, 8, 5, 7, 7_900),
    ]),
  }),
