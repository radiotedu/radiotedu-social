...
export const CAMPUS_CAT_DISPLAY_NAME = 'Kedü'
...
export const STUDY_GEAR: readonly StudyGearItem[] = Object.freeze([
  ...
  { id: 'pet-tarcin', kind: 'pet', name: CAMPUS_CAT_DISPLAY_NAME, description: 'A tiny ginger study companion.', price: 0, image: 'assets/study-gear/items/pet-tarcin.png' },
  { id: 'pet-benek', kind: 'pet', name: CAMPUS_CAT_DISPLAY_NAME, description: 'A curious spotted campus cat.', price: 140, image: 'assets/study-gear/items/pet-benek.png' },
  { id: 'pet-komur', kind: 'pet', name: CAMPUS_CAT_DISPLAY_NAME, description: 'A calm dark-coated companion.', price: 180, image: 'assets/study-gear/items/pet-komur.png' },
])
