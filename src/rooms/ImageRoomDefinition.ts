...
export type ImageRoomId = 'library' | 'chim-alan' | 'grass-amphitheatre' | 'sports-center' | 'auditorium' | 'learning-lab'
...
export const IMAGE_ROOMS: Readonly<Record<ImageRoomId, ImageRoomDefinition>> = Object.freeze({
  ...
  'chim-alan': withResolvedNodes(Object.freeze({ ...rooms['chim-alan'], title: 'Giriş' })),
  'grass-amphitheatre': withResolvedNodes(rooms['grass-amphitheatre']),
